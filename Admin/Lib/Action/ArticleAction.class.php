...
class ArticleAction extends CommonAction
{
    ...
    public function add()
    {
    	if (IS_POST) {
    		...
    		// 文章分类
    		$this->assign('articleCatOptions', D('ArticleCat') ->getFullOptions());
    		$this->display('edit');
		}
    }
    ...
    public function edit()
    {
    	if (IS_POST) {
    		...
    		if ($Model->create()) {
    			// 保存数据
    			if ($Model->save() !== false) {
    				$this->success('修改文章成功！', I('post.forward_url', U('Article/index')));
    			} else {
    				$this->error('修改文章失败！');
    			}
    		} else {
    		...
    		$this->assign('forward_url', I('server.HTTP_REFERER', U('Article/index')));
    		$this->display();
    	}
    }
