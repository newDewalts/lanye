...
class ServiceCatModel extends Model
{
	...
	protected  $_validate = array(
		array('cat_name', 'require', '网站服务分类名称不能为空!', Model::MUST_VALIDATE)
	);
	...
	{
		import("@.ORG.Tree");
		$serviceCatList = $this->order('orders DESC, cat_id ASC')->select();
		$Tree        = new Tree();
		$Tree->setTree($serviceCatList, 'cat_id', 'pid', 'cat_name');
