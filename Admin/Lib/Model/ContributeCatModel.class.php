...
class ContributeCatModel extends Model
{
	...
	protected  $_validate = array(
		array('cat_name', 'require', '节点名称不能为空!', 	Model::MUST_VALIDATE)
	);
	...
	{
		$sql = 'SELECT a.*, count(b.cat_id) AS children FROM __TABLE__ AS a LEFT JOIN '.C('DB_PREFIX').'contribute_cat AS b ON a.cat_id=b.pid WHERE a.pid='.intval($pid).' GROUP BY a.cat_id ORDER BY a.orders DESC, a.cat_id ASC';
