...
class Page {
    ...
    */
    ...
    protected $config  =    array(
    		...
    		'first'=>'首页',
    		'last'=>'末页',
    		'theme'=>'<div class="pagination text-center"><ul> %totalRow% %first% %prePage% %upPage% %linkPage% %downPage% %nextPage% %end%</ul></div>');
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    ...
                    $linkPage .= '<li class="disabled"><a href="#" class="current">'.$page.'</a></li>';
                }
            }
        }
        $pageStr     =   str_replace(
            ...
            array(
            		$this->config['header'],
            		$this->nowPage,
            		'<li class="disabled"><a href="#">'.$this->totalRows.$this->config['header'].'</a></li>',
            		$this->totalPages, 
            		$theFirst,
            		$upPage,
            		$prePage,
